        ...
        <div className="a-mob-menu">
          {[
            ...
            <a key={item.label} href={item.href} onClick={() => setMobileMenu(false)}
              style={{ color: "#374151", textDecoration: "none", fontSize: "15px", fontWeight: 600, padding: "10px 14px", borderRadius: "9px", background: "#fff", fontFamily: "sans-serif", border: "1px solid #e5e7eb" }}>
              {item.label}
            </a>
          ))}
        </div>
